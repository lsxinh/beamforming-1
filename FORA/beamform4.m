%FUNCTION final_sum = beamform4(signal_ft, window, aperture)
...
% change: now smaller resolution, sn spacing by 0.

function final_sum = beamform4(signal_ft, window1, aperture)
