...
int main(int argc, char *argv[])
{
	...
	// full beamformer
	////////////////////////////////////////////
	if (fabs(angle_start) > DELTA || fabs(angle_end - 360) > DELTA)
	{
		cerr << "Error: Full beamformer angles should be 0 to 360" << endl;
		exit(1);
	}
	...
	grid_r_inc = int(range_resolution / 2. /3.);
	...
	grid_mili_theta_min = 0;
	grid_mili_theta_max = 360 * 1000 - grid_mili_theta_inc;
	/*
